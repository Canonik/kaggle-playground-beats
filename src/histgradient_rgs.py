...
#best params: {'model__l2_regularization': np.float64(6.77432640331597), 'model__learning_rate': np.float64(0.022636907500873056), 'model__max_bins': 254, 'model__max_iter': 680, 'model__max_leaf_nodes': 29, 'model__min_samples_leaf': 29}